...
> SceneGraph apps use the [Video node](https://developer.roku.com/docs/references/scenegraph/media-playback-nodes/video.md) control field prebuffer option to implement Fast Video Start. See [Fast start media playback](https://developer.roku.com/docs/developer-program/core-concepts/playing-videos.md#fast-start-media-playback) for information on implementing Fast Video Start in a SceneGraph app.
