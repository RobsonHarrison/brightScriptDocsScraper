...
![roku815px - analytics-report-tabs](https://image.roku.com/ZHZscHItMTc2/channel-engagement-report.png)
## Filters
The filters applied to this report are:
  ...
  * **Streaming Store Code** - identifies the market where your app can legally be distributed. More than one code is allowed. The default is set to include all data from all available markets.
