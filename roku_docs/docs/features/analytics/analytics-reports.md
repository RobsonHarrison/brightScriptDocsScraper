...
**Analytics:**
  * [Channel Engagement](https://developer.roku.com/docs/features/analytics/channel-engagement.md) - installs, visits and streaming data for all apps
  * [Channel Health](https://developer.roku.com/docs/features/analytics/channel-health.md) - BrightScript crashes and buffering data for all apps
  * [Viewership Summary](https://developer.roku.com/docs/features/analytics/viewership-summary.md) - small selection of app engagement and app health data.
  * [Channel Stability](https://developer.roku.com/docs/features/analytics/channel-stability.md): BrightScript crashes and memory closures for all apps across all Roku device models.

**Sales reports:**
  * [Transaction](https://developer.roku.com/docs/features/analytics/transaction-report.md) - records all in-app transactions for SVOD or TVOD apps, such as product purchases, free trial initiations, and returns
  * [Sales Activity](https://developer.roku.com/docs/features/analytics/sales-activity-report.md) - displays daily transaction revenue totals by app, product, and currency within a window of up to one month
  * [Payout Audit](https://developer.roku.com/docs/features/analytics/payout-audit-report.md) - assists with reconciliation between app revenue activity and payouts received from Roku
  * [Tax Withholding](https://developer.roku.com/docs/features/analytics/tax-withholding-report.md) - Breaks down how net payouts are calculated after Roku's revenue share, tax withholding, and currency conversion are applied to app gross revenue.
...
![roku815px - analytics-report-tabs](https://image.roku.com/ZHZscHItMTc2/channel-stability-report-v4.png)
...
![roku815px - sales-reports-list](https://image.roku.com/ZHZscHItMTc2/sales-reports-left-nav.png)
...
![roku815px - analytics-2-filter-section](https://image.roku.com/ZHZscHItMTc2/analytics-report-filters.png)
...
![roku815px - roku_pay_transactions_schedule](https://image.roku.com/ZHZscHItMTc2/schedule-analytics-report-1.png)

  2. The **Schedule Delivery** dialog opens.
![roku600px - roku_pay_transactions_schedule](https://image.roku.com/ZHZscHItMTc2/engagement-report-destinations-s3.png)

  3. In the **Settings** tab, enter the following properties:
Field | Description
---|---
Schedule name | By default, the report name is based on the report type (for example, "Channel Engagement" or "Channel Health").

It is recommended that you enter a descriptive name for the schedule that makes it easy to identify in your list of schedules. For example, you can include the app name, format, frequency, time period or any other relevant information that distinguishes the schedule.
Recurrence | Configure the cadence used to email the report. You can send the report **Daily** , **Weekly** , **Monthly** , **Hourly** , or **By Minute** , or on specific months or days:
...
Once you select a cadence, configure the **Time** to send the report.
Destination | Select one of the following destinations to send the report:
...
The SFTP, S3, and Webhook options enable you to create automation pipelines for ingesting Roku analytics into your backend systems.
...
![roku600px - roku_pay_transactions_schedule](https://image.roku.com/ZHZscHItMTc2/schedule-delivery-filters-tab.png)
...
![roku600px - roku_pay_transactions_schedule](https://image.roku.com/ZHZscHItMTc2/schedule-delivery-adanced-tab.png)
...
![roku815px - analytics-6-published-countries](https://image.roku.com/ZHZscHItMTc2/analytics-6b.png)