...
The three main requirements for creating a Roku app are:
  ...
  * A place to [host your content](https://developer.roku.com/en-gb/docs/features/how-channels-work.md#content-hosting) on the web (for example, an OVP, CDN, and so on).
  * A [feed](https://developer.roku.com/en-gb/docs/features/how-channels-work.md#playing-hosted-videos-in-a-roku-channel), which brings your content onto the Roku platform.
...
![roku815px - videoplayback](https://image.roku.com/ZHZscHItMTc2/videoplayback.png)
...
After you've successfully set up your hosting server(s), you'll need to consider which of Roku's [two app development models](https://developer.roku.com/docs/features/channel-development-models.md) you'll want to use. This will determine a tremendous amount about your app, including the schema used for your content feed. To learn more, [read on](https://developer.roku.com/docs/features/channel-development-models.md)!