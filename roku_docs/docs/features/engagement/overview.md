...
Roku offers a robust promotional toolset for app publishers. This includes several free programs for organically driving content discovery such as [Roku Search](https://developer.roku.com/en-gb/docs/features/engagement/overview.md#roku-search), [Instant Signup](https://developer.roku.com/en-gb/docs/features/engagement/overview.md#instant-signup), and [Featured Free](https://developer.roku.com/en-gb/docs/features/engagement/overview.md#featured-free). These programs provide a high ROI as they typically require a simple integration and no economics.
Additionally, apps can further increase their exposure by leveraging [Roku's audience development](https://developer.roku.com/en-gb/docs/features/engagement/overview.md#audience-development) programs such as [self-serve Roku home screen display ads](https://developer.roku.com/en-gb/docs/features/engagement/overview.md#roku-home-screen-display-ads), on-device promotions (targeted display and video ads, microsites, remote control buttons), and off-device email marketing messages. These programs actively recommend content in your app to users that are most likely to be engaged by it.
...
See [Implementing Roku Search](https://developer.roku.com/docs/developer-program/discovery/search/implementing-search.md) to integrate your app into Roku Search.
![roku815px - roku-search-results](https://image.roku.com/ZHZscHItMTc2/roku-discovery-search-v3.png)
By participating in Roku Search, your app is eligible for three more discovery programs that provide additional exposure: [Visual Search Results for Roku Voice](https://developer.roku.com/en-gb/docs/features/engagement/overview.md#visual-search-results-for-roku-voice), [Roku Zones](https://developer.roku.com/en-gb/docs/features/engagement/overview.md#roku-zones) and [My Feed](https://developer.roku.com/en-gb/docs/features/engagement/overview.md#my-feed).
...
If a user requests content on a specific app (for example, "Bob the Builder on The Roku Channel" or "find Bob the Builder on The Roku Channel"), the Roku UI opens a page with matching content from that app in the top row. The rows below list relative [Roku Zones](https://developer.roku.com/en-gb/docs/features/engagement/overview.md#roku-zones) and TV shows, movies, and short-form videos from other apps in the Roku platform that are participating in Roku Search.
...
![roku815px - roku-voice-vsr-channel](https://image.roku.com/ZHZscHItMTc2/roku-voice-vsr-channel-v2.jpg)
### Roku Zones
...
![roku815px - roku-discovery-zones](https://image.roku.com/ZHZscHItMTc2/roku-discovery-zones-v4.png)
### Save List
...
See [Instant Signup](https://developer.roku.com/docs/developer-program/discovery/instant-signup.md) to integrate your SVOD app into this program.
...
![roku815px - roku-discovery-featuredFree](https://image.roku.com/ZHZscHItMTc2/roku-discovery-featuredFree-v3.png)
...
See [Self-Serve Promotions](https://developer.roku.com/docs/features/engagement/self-serve-promotions.md) for more information on purchasing display ads on the Roku home screen.
...
![roku815px - analytics-7-channel-engagement](https://image.roku.com/ZHZscHItMTc2/analytics-7.png)
See [Analytics and Reporting](https://developer.roku.com/docs/features/analytics/analytics-reports.md) for more information.