...
### GetInfo() as Object
Returns an associative array with the following key-value pairs, depending the value returned by the [GetData()](https://developer.roku.com/docs/references/brightscript/events/rotexttospeechevent.md#getinfo-as-object "GetData\(\)") method:
Key | Type | Value
---|---|---
...
### GetIndex() as Integer
The text to speech service may be shared among any number of clients; therefore, the IDs returned to a given client are not necessarily contiguous. The value is only meaningful if [GetData()](https://developer.roku.com/docs/references/brightscript/events/rotexttospeechevent.md#getinfo-as-object "GetData\(\)") returned 0, 1 or 2; it returns 0 otherwise.
This method returns the ID of the speech as returned by either the [Say()](https://developer.roku.com/docs/references/brightscript/interfaces/iftexttospeech.md#saytext-as-string-as-integer "Say\(\)")" or [Silence()](https://developer.roku.com/docs/references/brightscript/interfaces/iftexttospeech.md#silenceduration-as-integer-as-integer "Silence\(\)") methods of the [ifTextToSpeech](https://developer.roku.com/docs/references/brightscript/interfaces/iftexttospeech.md "ifTextToSpeech") interface.