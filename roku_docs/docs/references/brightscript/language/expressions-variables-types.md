...
Identifiers (names of variables, functions, labels, or object member functions or interfaces (appear after a ".")) have the following rules.
  ...
  * May not use a "reserved word" as the name (see [Reserved Words](https://developer.roku.com/docs/references/brightscript/language/reserved-words.md) for list of reserved words).
...
![roku815px - expressionsvariables1](https://image.roku.com/ZHZscHItMTc2/expressionsvariables1.png)
**When debugging**
...
![roku815px - expressionsvariables2](https://image.roku.com/ZHZscHItMTc2/expressionsvariables2.png)
To comment out multiple lines, precede each of them with REM or apostrophe. To "block comment" big chunks of text, consider using [conditional compilation](https://developer.roku.com/docs/references/brightscript/language/conditional-compilation.md).
### In XML
...
![roku815px - expressionsvariables3](https://image.roku.com/ZHZscHItMTc2/expressionsvariables3.png)
## Literals (constants)
