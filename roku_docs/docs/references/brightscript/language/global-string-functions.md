...
(For integer values, _value_.ToStr() may be used instead if a leading blank for non-negative numbers is not desired. See [ifIntOpts](https://developer.roku.com/docs/references/brightscript/interfaces/ifintops.md) in [roInt](https://developer.roku.com/docs/references/brightscript/components/roint.md)).
See the [ifStringOps](https://developer.roku.com/docs/references/brightscript/interfaces/ifstringops.md) interface in [roString](https://developer.roku.com/docs/references/brightscript/components/rostring.md) for the corresponding inverse / string-to-value functions ToInt() and ToFloat().
