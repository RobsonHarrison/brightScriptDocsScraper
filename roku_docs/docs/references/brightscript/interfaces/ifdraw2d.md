...
> When working with an [roScreen](https://developer.roku.com/docs/references/brightscript/components/roscreen.md "roScreen") object, the [ifScreen.SwapBuffers()](https://developer.roku.com/docs/references/brightscript/interfaces/ifscreen.md#swapbuffers-as-void) method should be used instead of this method.