...
> For code demonstrating how to check whether a Roku device (STB or TV) can play 4K content, see the [streaming specification](https://developer.roku.com/docs/specs/media/streaming-specifications.md#4k-uhd-video-streaming-requirements).
