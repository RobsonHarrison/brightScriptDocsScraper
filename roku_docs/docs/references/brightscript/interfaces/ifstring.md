...
[roUrlEvent](https://developer.roku.com/docs/references/brightscript/events/rourlevent.md "roUrlEvent") | The roUrlTransfer component sends the roUrlEvent component
## Supported methods
