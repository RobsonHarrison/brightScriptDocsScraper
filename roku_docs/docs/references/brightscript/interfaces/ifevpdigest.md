...
### Reinit() as Integer
#### Description
Re-initializes an existing message digest context. This can be called to reuse an existing [roEVPDigest](https://developer.roku.com/docs/references/brightscript/components/roevpdigest.md "roEVPDigest") object to digest new data.
#### Return Value
Returns 0 on success or non-zero on failure.
