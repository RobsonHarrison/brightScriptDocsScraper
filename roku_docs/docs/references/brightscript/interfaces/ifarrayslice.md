...
[roByteArray](https://developer.roku.com/docs/references/brightscript/interfaces/ifbytearray.md) | The byte array component is used to contain and manipulate an arbitrary array of bytes
## Supported methods
