...
---|---|---|---|---
isSameNode | Boolean |  | Name | Type | Description
---|---|---
RoSGNode | Object | The roSGNode to be checked.
True/False | Returns a Boolean value indicating whether the RoSGNode parameter refers to the same SceneGraph node object as the subject node
#### Return Value
...
Name | Return Type | Parameters | Return Value | Description
---|---|---|---|---
clone | Object |  | Name | Type | Description
---|---|---
isDeepCopy | Boolean | True = return a copy of the entire node tree.
False = return a shallow copy of the node tree.
Node tree |
#### Return Value
A node tree.
