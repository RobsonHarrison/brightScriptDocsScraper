...
> This function does not return the items contained in the roXMLList. Use [ifList](https://developer.roku.com/docs/references/brightscript/interfaces/iflist.md "ifList") functions to access those items.
#### Return Value
The object item.