...
## Supported events
  * [roChannelStoreEvent](https://developer.roku.com/docs/references/brightscript/events/rochannelstoreevent.md "roChannelStoreEvento")