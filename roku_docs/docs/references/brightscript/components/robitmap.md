...
See the [Roku streaming specification](https://developer.roku.com/docs/specs/media/streaming-specifications.md#supported-image-formats) for the image formats supported by this component.
