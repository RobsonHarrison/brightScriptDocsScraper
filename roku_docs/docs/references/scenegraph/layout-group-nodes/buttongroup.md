# ButtonGroup
Extends [**LayoutGroup**](https://developer.roku.com/docs/references/scenegraph/layout-group-nodes/layoutgroup.md "**LayoutGroup**")
...
textFont | Font | system: MediumSystemFont | READ_WRITE | Specifies the [Font](https://developer.roku.com/docs/references/scenegraph/typographic-nodes/font.md "Font") node for all unfocused Button nodes in the group. Only set to override the system default. See Font for a list of all system fonts available
focusedTextFont | Font | system: MediumBoldSystemFont | READ_WRITE | Specifies the [Font](https://developer.roku.com/docs/references/scenegraph/typographic-nodes/font.md "Font") node for the Button node that has focus, if any. Only set to override the system default. See Font for a list of all system fonts available
