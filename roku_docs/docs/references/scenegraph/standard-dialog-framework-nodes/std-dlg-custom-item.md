...
> To enable a **StdDlgCustomItem** node to gain focus (for example, if it includes a custom keyboard node), set its **focusable** field to true (this field is inherited from the base [Node class](https://developer.roku.com/docs/references/scenegraph/node.md)).
## Sample app
