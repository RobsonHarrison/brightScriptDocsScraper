...
> Component libraries cannot be used to load the [Roku Advertising Framework (RAF) library](https://developer.roku.com/docs/developer-program/advertising/integrating-roku-advertising-framework.md).
### Manifest
