...
![roku815px - LabelList-example1](https://image.roku.com/ZHZscHItMTc2/LabelList-example1.jpg)
## Fields
Field | Type | Default | Access Permission | Description
---|---|---|---|---
content | ContentNode | none | READ_WRITE | Specifies the content for the list. See [Data bindings](https://developer.roku.com/docs/references/scenegraph/list-and-grid-nodes/labellist.md#data-bindings) below for more details.
