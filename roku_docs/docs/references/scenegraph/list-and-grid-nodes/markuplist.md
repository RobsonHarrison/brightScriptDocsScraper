...
[SimpleMarkupList](https://github.com/rokudev/samples/tree/master/ux%20components/lists%20and%20grids) is a sample app containing a MarkupList where each item is an instance of an XML component. See the [MarkupList XML component](https://developer.roku.com/en-gb/docs/references/scenegraph/list-and-grid-nodes/markuplist.md#markuplist-xml-component) section for details.
**Example**
The following example displays the use of the MarkupList node.
![roku815px - markuplist-node](https://image.roku.com/ZHZscHItMTc2/markuplist-node.png)
## Fields
Field | Type | Default | Access Permission | Description
---|---|---|---|---
itemComponentName | string |  | READ_WRITE | Specifies the name of a XML component for the list items. An instance of this component is created on demand for each visible item of the list. The XML component must define a specific interface as detailed in [MarkupList XML component](https://developer.roku.com/docs/references/scenegraph/list-and-grid-nodes/markuplist.md#MarkupList-XML-Component) below.
