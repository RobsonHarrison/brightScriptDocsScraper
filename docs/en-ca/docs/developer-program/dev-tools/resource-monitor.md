...
## Change log
  * v4.2 (September 10, 2025)
    * Added [Data Collection Mode (CLI support for RRM)](https://developer.roku.com/en-ca/docs/developer-program/dev-tools/\(/docs/developer-program/dev-tools/rrm-data-collection-mode.md\)) for macOS, Linux, and Windows.
