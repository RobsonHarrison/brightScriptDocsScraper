...
SceneGraph [Poster nodes](https://developer.roku.com/docs/references/scenegraph/renderable-nodes/poster.md) can now accept URIs that provide WebP images, and those images can optionally have alpha channels for transparency (similar to the PNG approach).
...
[↩](https://developer.roku.com/en-gb/docs/specs/media/streaming-specifications.md#fnref-1)
  2. Only supported on **Roku 4K capable** devices.
[↩](https://developer.roku.com/en-gb/docs/specs/media/streaming-specifications.md#fnref-2)
...
[↩](https://developer.roku.com/en-gb/docs/specs/media/streaming-specifications.md#fnref-3)
...
[↩](https://developer.roku.com/en-gb/docs/specs/media/streaming-specifications.md#fnref-4)
...
[↩](https://developer.roku.com/en-gb/docs/specs/media/streaming-specifications.md#fnref-5)
  6. Only supported on HDR10 capable Roku devices.
[↩](https://developer.roku.com/en-gb/docs/specs/media/streaming-specifications.md#fnref-6)