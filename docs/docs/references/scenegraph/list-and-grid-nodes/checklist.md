# CheckList
Extends [**LabelList**](https://developer.roku.com/docs/references/scenegraph/list-and-grid-nodes/labellist.md)
...
![roku815px - CheckList](https://image.roku.com/ZHZscHItMTc2/CheckList.png)
## Fields
