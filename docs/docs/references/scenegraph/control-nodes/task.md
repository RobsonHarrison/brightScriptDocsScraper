...
Also review "[SceneGraph threads](https://developer.roku.com/docs/developer-program/core-concepts/threads.md "SceneGraph")" for in-depth information on using Task nodes most efficiently.
### Example
