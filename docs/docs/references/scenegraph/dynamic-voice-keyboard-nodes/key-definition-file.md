...
The Key Definition File is a single JSON object with the following six hierarchal objects (listed in order from the top to the bottom of the hierarchy):
  1. [KeyLayout](https://developer.roku.com/en-gb/docs/references/scenegraph/dynamic-voice-keyboard-nodes/key-definition-file.md#keylayout)
  2. [Section](https://developer.roku.com/en-gb/docs/references/scenegraph/dynamic-voice-keyboard-nodes/key-definition-file.md#section)
  3. [Grid](https://developer.roku.com/en-gb/docs/references/scenegraph/dynamic-voice-keyboard-nodes/key-definition-file.md#grid)
  4. [Row](https://developer.roku.com/en-gb/docs/references/scenegraph/dynamic-voice-keyboard-nodes/key-definition-file.md#row)
  5. [Key](https://developer.roku.com/en-gb/docs/references/scenegraph/dynamic-voice-keyboard-nodes/key-definition-file.md#key)
  6. [KeySuggestions](https://developer.roku.com/en-gb/docs/references/scenegraph/dynamic-voice-keyboard-nodes/key-definition-file.md#keysuggestions)
