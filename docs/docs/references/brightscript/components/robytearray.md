...
## Supported interfaces
  * [ifByteArray](https://developer.roku.com/docs/references/brightscript/interfaces/ifbytearray.md "ifByteArray")
  ...
  * [ifArraySlice](https://developer.roku.com/docs/references/brightscript/interfaces/ifarrayslice.md)
