...
## Supported interfaces
  * [ifSocketConnection](https://developer.roku.com/docs/references/brightscript/interfaces/ifsocketconnection.md "ifSocketConnection")
  * [ifSocket](https://developer.roku.com/docs/references/brightscript/interfaces/ifsocket.md "ifSocket")
  * [ifSocketAsync](https://developer.roku.com/docs/references/brightscript/interfaces/ifsocketasync.md "ifSocketAsync")
  * [ifSocketStatus](https://developer.roku.com/docs/references/brightscript/interfaces/ifsocketstatus.md "ifSocketStatus")
  * [ifSocketConnectionStatus](https://developer.roku.com/docs/references/brightscript/interfaces/ifsocketconnectionstatus.md "ifSocketConnectionStatus")
  * [ifSocketConnectionOption](https://developer.roku.com/docs/references/brightscript/interfaces/ifsocketconnectionoption.md "ifSocketConnectionOption")
  * [ifSocketOption](https://developer.roku.com/docs/references/brightscript/interfaces/ifsocketoption.md)

## Supported events
  * [roSocketEvent](https://developer.roku.com/docs/references/brightscript/events/rosocketevent.md "roSocketEvent")