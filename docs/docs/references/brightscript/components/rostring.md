...
## Supported interfaces
  * [ifString](https://developer.roku.com/docs/references/brightscript/interfaces/ifstring.md "ifString")
  * [ifStringOps](https://developer.roku.com/docs/references/brightscript/interfaces/ifstringops.md "ifStringOps")
