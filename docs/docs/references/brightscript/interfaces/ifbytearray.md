...
#### Description
Returns the signed byte at the specified zero-based index in the Byte ArrayUse the [ifArrayGet.GetEntry()](https://developer.roku.com/docs/references/brightscript/interfaces/ifarrayget.md#getentryindex-as-integer-as-dynamic) method or the [ ] array operator to read an unsigned byte in the Byte Array.
#### Parameters
Name | Type | Description
---|---|---
