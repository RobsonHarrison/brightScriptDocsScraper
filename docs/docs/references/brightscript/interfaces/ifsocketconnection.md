...
Checks whether if the [listen()](https://developer.roku.com/en-gb/docs/references/brightscript/interfaces/ifsocketconnection.md#listenbacklog-as-integer-as-boolean) method has been successfully called on this socket.
#### Return Value
A flag indicating whether the [listen()](https://developer.roku.com/en-gb/docs/references/brightscript/interfaces/ifsocketconnection.md#listenbacklog-as-integer-as-boolean) method has been successfully called on this socket.
### Connect() as Boolean
#### Description
...
#### Description
Checks whether a [connect](https://developer.roku.com/en-gb/docs/references/brightscript/interfaces/ifsocketconnection.md#connect-as-boolean) or [accept](https://developer.roku.com/en-gb/docs/references/brightscript/interfaces/ifsocketconnection.md#accept-as-object) function has been completed on this socket.
#### Return Value
