...
Name | Description
---|---
[roFileSystem](https://developer.roku.com/docs/references/brightscript/components/rofilesystem.md "roFile System") | The roFilesystem component implements common filesystem inspection and modification routines
## Supported methods
The format of file and directory pathnames is described on the [File System](https://developer.roku.com/docs/developer-program/getting-started/architecture/file-system.md "File System") page.
### GetVolumeList() as Object
#### Description
Returns the available volumes on the device.
#### Return Value
An [roList](https://developer.roku.com/docs/references/brightscript/components/rolist.md "roList") containing strings representing the available volumes.
...
#### Return Value
An [roList](https://developer.roku.com/docs/references/brightscript/components/rolist.md "roList") of strings representing the directory listing of names in dirPath.
...
#### Return Value
An [roList](https://developer.roku.com/docs/references/brightscript/components/rolist.md "roList") of Strings representing the directory listing of names in dirPath that match the regex.
...
regex | String | The regex to be used to search for files.
#### Return Value
An [roList](https://developer.roku.com/docs/references/brightscript/components/rolist.md "roList") of Strings representing the directory listing of names in dirPath that match the regex. Each item in the list is the name of the file relative to dirPath.
### Match(path as String, pattern as String) as Object
#### Description
Returns the file names in the specified directory path matching the provided shell-like pattern. This method is similar to the [Find()](https://developer.roku.com/en-gb/docs/references/brightscript/interfaces/iffilesystem.md#finddirpath-as-string-regex-as-string-as-object) method except that it uses shell-like pattern matching rather than regular expression matching.
#### Parameters
Name | Type | Description
---|---|---
...
#### Return Value
An [roList](https://developer.roku.com/docs/references/brightscript/components/rolist.md "roList") of Strings representing the directory listing of names in dirPath that match the shell-like pattern.
...
path | String | The directory path to be checked.
#### Return Value
An [roAssociativeArray](https://developer.roku.com/docs/references/brightscript/components/roassociativearray.md "roAssociativeArray") containing the following key-value pairs for the specified path:
Name | Type | Values
---|---|---
type | String |
  * "file"
