...
![roku815px - rectangle-group1](https://image.roku.com/ZHZscHItMTc2/rectangle-group1.png)
The next illustration shows the Yellow rectangle's localBoundingRect().
![roku815px - rectangle-group2](https://image.roku.com/ZHZscHItMTc2/rectangle-group2.png)
The next illustration shows the Yellow rectangle's boundingRect(), which is relative to it's parent's coordinate system.
![roku815px - rectangle-group3](https://image.roku.com/ZHZscHItMTc2/rectangle-group3.png)
The next illustration shows the Yellow rectangle's sceneBoundingRect(), which is relative to the Scene's coordinate system.
![roku815px - rectangle-group4](https://image.roku.com/ZHZscHItMTc2/rectangle-group4.png)
...
![roku815px - rectangle-group5](https://image.roku.com/ZHZscHItMTc2/rectangle-group5.png)
...
![roku815px - rectangle-group6](https://image.roku.com/ZHZscHItMTc2/rectangle-group6.png)
The last illustration shows the Green rectangle's sceneBoundingRect(), which is relative to the Scene's coordinate system.
![roku815px - rectangle-group7](https://image.roku.com/ZHZscHItMTc2/rectangle-group7.png)