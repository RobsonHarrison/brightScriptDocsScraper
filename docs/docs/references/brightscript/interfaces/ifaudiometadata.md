...
Name | Description
---|---
[roAudioMetadata](https://developer.roku.com/docs/references/brightscript/components/roaudiometadata.md "roAudioMetadata") | This component provides developers access to audio file metadata included in many audio files
## Supported methods
