...
Name | Description
---|---
[roRegistrySection](https://developer.roku.com/docs/references/brightscript/components/roregistrysection.md "roRegistrySection") | A Registry Section enables the organization of settings within the registry
## Supported methods
...
#### Description
Replaces the value of the specified key. Does not guarantee a commit to non-volatile storage until an explicit [Flush()](https://developer.roku.com/en-gb/docs/references/brightscript/interfaces/ifregistrysection.md#flush-as-boolean) is done.
#### Parameters
Name | Type | Description
---|---|---
