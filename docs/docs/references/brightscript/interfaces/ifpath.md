...
#### Return Value
An [roAssociativeArray](https://developer.roku.com/docs/references/brightscript/components/roassociativearray.md "roAssociativeArray") that contains the following keys:
Name | Type | Description
---|---|---
