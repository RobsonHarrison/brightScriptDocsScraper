...
> This function always returns the canonical English day of week names, regardless of the current locale. For a locale-independent index, see the [GetDayOfWeek()](https://developer.roku.com/en-gb/docs/references/brightscript/interfaces/ifdatetime.md#getdayofweek-as-integer) function.
#### Return Value
