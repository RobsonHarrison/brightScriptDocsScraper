...
### SwapBuffers() as Void
#### Description
This function first operates the same as a call to [ifDraw2D](https://developer.roku.com/docs/references/brightscript/interfaces/ifdraw2d.md "ifDraw2D"), completing all queued drawing operations on the back buffer (draw surface).
