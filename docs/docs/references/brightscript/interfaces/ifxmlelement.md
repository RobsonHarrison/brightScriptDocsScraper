...
#### Description
If this element contains any child elements, this method returns an [roXMLList](https://developer.roku.com/docs/references/brightscript/components/roxmllist.md "roXMLList") representing those elements. If there are no child elements, returns invalid.
