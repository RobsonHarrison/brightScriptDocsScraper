...
Name | Description
---|---
[roTimespan](https://developer.roku.com/docs/references/brightscript/components/rotimespan.md "roTimespan") | The Timespan object provides an interface to a simple timer for tracking the duration of activities
## Supported methods
### Mark() as Void
#### Description
