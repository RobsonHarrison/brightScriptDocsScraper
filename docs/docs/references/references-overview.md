...
Aspects of the last question are specially covered in the separate [Deprecated APIs](https://developer.roku.com/docs/references/deprecated-apis.md) document, which developers should revisit periodically, or whenever notified by Roku, in order to keep their channels current for certification purposes.