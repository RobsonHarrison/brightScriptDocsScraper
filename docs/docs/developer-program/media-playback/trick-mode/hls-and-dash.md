...
> Developers who want to create standard-thumbnail files can find instructions for doing so [here](https://developer.roku.com/en-gb/docs/developer-program/media-playback/trick-mode/hls-and-dash.md#standard-thumbnail-file-creation).
## DASH considerations
