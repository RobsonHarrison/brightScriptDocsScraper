...
Screensavers **cannot** include:
  * [DynamicComponent libraries](https://developer.roku.com/docs/references/scenegraph/control-nodes/componentlibrary.md)
  * Ad insertion
  * In-app purchases
  * Deep links
...
The screensaver's [BrightScript Debugger](https://developer.roku.com/docs/developer-program/debugging/debugging-channels.md) uses port 8087.
## Discovery
...
![roku815px - screensavers menu](https://image.roku.com/ZHZscHItMTc2/screensavers-menu.png)
## Settings
...
![roku815px - change screensaver settings](https://image.roku.com/ZHZscHItMTc2/change-screensaver-settings.png)
...
## Manifest entries
A screensaver must have an entry in its [manifest file](https://developer.roku.com/docs/developer-program/getting-started/architecture/channel-manifest.md) named **`screensaver_title`**whose value is the title of the screensaver (usually the same as the title of the app).
