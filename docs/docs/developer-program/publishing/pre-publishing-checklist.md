...
#### Regional compliance
  * [Localize](https://developer.roku.com/docs/developer-program/core-concepts/localization.md) the language of all relevant textual or graphic elements to the predominating language in the territory.
