...
Onboarding and deploying Nielsen DCR entails the following steps:
  ...
  4. Your TAM will test your app to ensure that the integration is functioning properly and all of the necessary data is present and triggered appropriately.
