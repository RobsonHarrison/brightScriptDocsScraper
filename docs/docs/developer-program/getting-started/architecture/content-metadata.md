...
| --- | --- | --- | --- |
| ContentType  | String  | Although ContentType accepts type String, the return value is of type [roInt](https://developer.roku.com/docs/references/brightscript/components/roint.md). See table below.
...
| --- | --- | --- | --- |
| cdnConfig  | roArray of roAssociativeArrays  |
