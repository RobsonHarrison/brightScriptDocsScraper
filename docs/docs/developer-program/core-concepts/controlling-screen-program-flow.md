...
There are two more examples that allow users to select and play videos from a custom RowList node:
  * [Simple_Grid_and_Video](https://github.com/rokudev/samples/blob/master/ux%20components/lists%20and%20grids/Simple_Grid_and_Video)
