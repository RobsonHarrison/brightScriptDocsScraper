...
![roku600px - remote](https://image.roku.com/ZHZscHItMTc2/WMT-Roku-RSS-Remote-black-button-v2.png)
...
See [Trick Mode](https://developer.roku.com/docs/developer-program/media-playback/trick-mode/trick-mode.md) for more information.
