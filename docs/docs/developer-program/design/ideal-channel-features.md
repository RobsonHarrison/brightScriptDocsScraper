...
## BIFs/Trick mode
  ...
  * To that end, all video navigation must be visual so users can actually see/preview the video they are navigating:
    * [Enable video scrubbing](https://developer.roku.com/docs/developer-program/media-playback/trick-mode.md)
    * Show [BIFs](https://developer.roku.com/docs/developer-program/media-playback/trick-mode.md#bif-file-creation-using-the-roku-bif-tool) or key-frames
![roku815px - trickmode](https://image.roku.com/ZHZscHItMTc2/trickmode.png)
