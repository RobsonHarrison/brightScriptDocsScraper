##
Developer terms
[](https://developer.roku.com/dev/docs/legal#developer-terms)
By becoming a Roku Developer, you are subject to and agree to comply with all applicable Developer Terms, and any other terms, rules, and policies applicable to the Developer Program that Roku makes available to you.
  * [Certification Requirements](https://developer.roku.com/dev/docs/certification)
...
[](https://developer.roku.com/dev/docs/legal#developer-agreements)
...
##
Compliance
[](https://developer.roku.com/dev/docs/legal#compliance)
...
###
CVAA
[](https://developer.roku.com/dev/docs/legal#cvaa)
...
###
COPPA
[](https://developer.roku.com/dev/docs/legal#coppa)
...
###
GDPR
[](https://developer.roku.com/dev/docs/legal#gdpr)
...
Here are some things to consider:
  * If using a third-party ad server, are you respecting the "Limit ad tracking" parameter set by the user, as determined by the [IsRIDADisabled()](https://developer.roku.com/dev/docs/ifdeviceinfo#isridadisabled-as-boolean) API?
...
[](https://developer.roku.com/dev/docs/legal#specific-country-legal-requirements)
