...
Learn more about the APIs to add purchases to your apps:
  ...
  * [ChannelStore node](https://developer.roku.com/docs/references/scenegraph/control-nodes/channelstore.md)

## Packaging
Regarding protecting the code and assets within an app, we require that all apps are [packaged](https://developer.roku.com/docs/developer-program/publishing/packaging-channels.md) with a secure encryption key. When apps are submitted for the Streaming Store, the encrypted package is uploaded from the Developer Dashboard, ensuring that only the Roku device playing content has the secure package running. [Read more about app packaging](https://developer.roku.com/docs/developer-program/publishing/packaging-channels.md).
...
For more details on DRM support, see [DRM details](https://developer.roku.com/docs/specs/media/content-protection.md).
## Content protection
...
For more details, see [Content Protection](https://developer.roku.com/docs/specs/media/content-protection.md#copy-protection).
**Related resources:**
  * [How apps work](https://developer.roku.com/docs/features/features-overview.md#how-channels-work)
  * [Packaging apps](https://developer.roku.com/docs/developer-program/publishing/packaging-channels.md)
  * [DRM details](https://developer.roku.com/docs/specs/media/content-protection.md#drm)
  * [Content protection](https://developer.roku.com/docs/specs/media/content-protection.md#copy-protection)